...
def send_data_to_server(config_dict):
    ...
    s = socket.socket(ip_utils.get_ip_version(ip), socket.SOCK_DGRAM, 0)
...
def write_default_configfile():
    ...
    config_dict['current_ip_version'] = ''
...
if(__name__ == "__main__"):
    ...
    if(config_dict):
        ip = ip_utils.get_ip_address_as_string(config_dict['current_ip_version'])
