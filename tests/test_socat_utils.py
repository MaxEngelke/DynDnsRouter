...
class TestSocatUtils(unittest.TestCase):
    ...
    def test_start_and_stop_socat_processes(self):
        ...
        pid1, err  = socat_utils.start_socat_process('tcp', '56841', '::1', '63251')
        pid2, err  = socat_utils.start_socat_process('tcp', '56842', '::1', '63252')
        pid3, err  = socat_utils.start_socat_process('udp', '56843', '::1', '63253')
        pid4, err  = socat_utils.start_socat_process('udp', '56844', '::1', '63254')
        pid5, err  = socat_utils.start_socat_process('tcp', '56845', '::1', '63255')
